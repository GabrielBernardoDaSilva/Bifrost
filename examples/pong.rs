...
//     },
//     core::{component::{AsAny, Component}, lifetime_system_exec::LifetimeSystemExec, scene::Scene, query::{QueryFetched, Query}},
...
//             for (_, (sprite, name)) in query.iter_mut() {
//                 if name.0 == "Ball" {
...
// // fn close_window(scene: &mut Scene) {
// //     let keys = scene.query_single::<&Input<Keys>>();
// //     if let Some(action) = keys.get_key(Key::Escape) {
// //         if action == &glfw::Action::Press {
// //             scene.stop();
